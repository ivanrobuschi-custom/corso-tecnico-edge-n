...
Questo strumento diagnostico e di configurazione è sviluppato per interfacciarsi direttamente con i protocolli nativi del dispositivo. L'applicativo consente al personale tecnico di compilare e trasmettere l'intero set di parametri fiscali aggirando completamente la navigazione tramite web browser e l'uso della tastiera virtuale.
